...
Step 2   cursorqb-subplanner -> Phase-*-Plans/ + Sub-Planning-Index.md  (goal-backed)    [validator step2]
 Gate 2 audit approval
Step 3   cursorqb-auditor     -> Sub-Planning-Audit.md                (goal-backed)    [validator step3]
...
- Approve -> launch Step 3 via the **define-goal procedure above** (Canonical Step-3 goal text), then
  follow the **`cursorqb-auditor`** skill until it produces `Planner-docs/Sub-Planning-Audit.md` and returns a status.
