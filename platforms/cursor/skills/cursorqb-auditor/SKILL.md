...
- **PASS_WITH_WARNINGS** -> if there are no P0/P1 findings, Step 4 may begin with the P2/P3 warnings
  kept visible; if any P0/P1 finding exists, hand the prioritized fix list back to `cursorqb-planner`
