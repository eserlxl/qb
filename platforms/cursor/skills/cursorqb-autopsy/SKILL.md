...
Report: whether Step 1.5 succeeded, was skipped, or was blocked; whether `Autopsy.md` was created/updated; the highest-priority `AUTOPSY-P0/P1` signals; how Step 2 should use the report; and confirmation that only `Planner-docs/Autopsy.md` changed. Control returns to `cursorqb-planner` (Gate 1 feedback covers both `Main-Planing.md` and `Autopsy.md`); Step 2 (`cursorqb-subplanner`) reads `Autopsy.md` as supporting feedback.
