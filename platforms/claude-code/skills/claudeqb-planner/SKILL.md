...
Step 2   claudeqb-subplanner -> Phase-*-Plans/ + Sub-Planning-Index.md  (delegated)      [validator step2]
 Gate 2 audit approval
Step 3   claudeqb-auditor     -> Sub-Planning-Audit.md                (delegated)      [validator step3]
...
- Approve -> launch Step 3 via the **delegation procedure above** (Canonical Step-3 brief), then
  run the **`claudeqb-auditor`** subagent/skill until it produces `Planner-docs/Sub-Planning-Audit.md` and returns a status.
