---
name: qb-subplanner
description: Step 2 of the QB planning workflow. Use to decompose every main phase in Planner-docs/Main-Planning.md into detailed sub-plans under Planner-docs/Phase-<n>-Plans/ plus Sub-Planning-Index.md. Runs under an explicit goal contract until ALL phases are covered - it does not stop after one phase. Invoke from qb-planner Gate 1 (the orchestrator delegates this step to the qb-subplanner subagent), or run directly to (re)generate sub-plans. Only changes files under Planner-docs/.
---
