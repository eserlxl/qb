---
name: qb-autopsy
description: Subagent-backed Step 1.5 of the QB planning workflow - an existing-project autopsy. Use after Step 1 (or directly) to inspect an existing/partially built repository and write Planner-docs/Autopsy.md, a 13-section technical feedback report that enriches Step 2 sub-plans. Runs automatically for existing/non-empty repositories and is skipped for empty or nearly empty ones. This skill is the spec that the qb-autopsy subagent follows; only creates/updates Planner-docs/Autopsy.md.
---

# QB Autopsy (Step 1.5, subagent-backed)
