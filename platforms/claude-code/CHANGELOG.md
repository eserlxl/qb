...
- **BREAKING — planning-artifact identifiers renamed to plain English.** The Turkish
  ...
  **Migration:** `Planner-docs/` directories generated by 0.1.x are not recognized by
  the 0.2.0 validator. Either re-run the workflow to regenerate them, or rename the
