...
|---|---|
| Test modules (`tests/test_*.py`) | 80 |
| Test functions | 633 |
| Failures | 0 |
| Errors | 0 |
| Exit status | 0 |

A run reporting anything other than 80 modules or 633 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (80 modules / 633 functions) passes. |
...
| Expected test modules | 80 |
| Expected test functions | 633 |
