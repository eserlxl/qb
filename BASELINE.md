...
A run reporting anything other than 76 modules or 562 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (76 modules / 562 functions) passes. |
