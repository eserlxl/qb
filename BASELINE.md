...
A run reporting anything other than 74 modules or 542 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (74 modules / 542 functions) passes. |
