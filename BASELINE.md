...
A run reporting anything other than 76 modules or 587 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (76 modules / 587 functions) passes. |
