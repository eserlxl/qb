...
A run reporting anything other than 80 modules or 635 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (80 modules / 635 functions) passes. |
