...
A run reporting anything other than 81 modules or 643 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (81 modules / 643 functions) passes. |
