...
A run reporting anything other than 82 modules or 668 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (82 modules / 668 functions) passes. |
