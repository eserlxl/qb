...
|---|---|
| Test modules (`tests/test_*.py`) | 73 |
| Test functions | 537 |
| Failures | 0 |
| Errors | 0 |
| Exit status | 0 |

A run reporting anything other than 73 modules or 537 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (73 modules / 537 functions) passes. |
...
| Expected test modules | 73 |
| Expected test functions | 537 |
