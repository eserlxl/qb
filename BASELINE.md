...
|---|---|
| Test modules (`tests/test_*.py`) | 77 |
| Test functions | 592 |
| Failures | 0 |
| Errors | 0 |
| Exit status | 0 |

A run reporting anything other than 77 modules or 592 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (77 modules / 592 functions) passes. |
...
| Expected test modules | 77 |
| Expected test functions | 592 |
