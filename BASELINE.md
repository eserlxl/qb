...
A run reporting anything other than 81 modules or 638 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (81 modules / 638 functions) passes. |
