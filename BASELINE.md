...
A run reporting anything other than 83 modules or 682 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (83 modules / 682 functions) passes. |
