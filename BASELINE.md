...
A run reporting anything other than 82 modules or 677 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (82 modules / 677 functions) passes. |
