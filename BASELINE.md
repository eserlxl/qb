...
|---|---|
| Test modules (`tests/test_*.py`) | 83 |
| Test functions | 685 |
| Failures | 0 |
| Errors | 0 |
| Exit status | 0 |

A run reporting anything other than 83 modules or 685 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (83 modules / 685 functions) passes. |
...
| Expected test modules | 83 |
| Expected test functions | 685 |
