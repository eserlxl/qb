...
A run reporting anything other than 76 modules or 569 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (76 modules / 569 functions) passes. |
