...
A run reporting anything other than 79 modules or 627 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (79 modules / 627 functions) passes. |
