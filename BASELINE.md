...
A run reporting anything other than 72 modules or 518 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (72 modules / 518 functions) passes. |
