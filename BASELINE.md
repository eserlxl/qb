...
A run reporting anything other than 71 modules or 499 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (71 modules / 499 functions) passes. |
