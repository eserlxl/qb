...
A run reporting anything other than 72 modules or 523 passing test cases, or any
...
| `python3 -m unittest discover -s tests` | The full cross-platform invariant suite (72 modules / 523 functions) passes. |
