...
| [telemetry-trends.md](telemetry-trends.md) | The per-run telemetry series and the per-dimension improving/regressing/stable trend verdict over a window. | `shared/scripts/telemetry_trends.py`, `shared/scripts/telemetry_aggregate.py` |
